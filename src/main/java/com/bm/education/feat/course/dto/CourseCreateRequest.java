...
public record CourseCreateRequest(
                ...
                @NotBlank(message = "Описание обязательно") @Size(min = 50, max = 5000, message = "Описание должно содержать от 50 до 5000 символов") String description,

                @NotBlank(message = "Краткое описание обязательно") @Size(max = 500, message = "Краткое описание не должно превышать 500 символов") String shortDescription,
