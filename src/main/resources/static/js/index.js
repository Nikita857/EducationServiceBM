            ...
            <div class="table-row">
                ...
                <div class="table-cell">
                    <span class="badge ${module.moduleStatus === 'ACTIVE' ? 'bg-success' : 'bg-secondary'}" style="cursor: pointer" onclick="adminUpdateModuleStatus(${module.moduleId}, '${module.moduleStatus}')">
                        ${$7898aba61f4f51c3$var$escapeHtml(module.moduleStatus)}
                    </span>
                </div>
                <div class="table-cell action-buttons">
...
async function $d810eae5683564e2$var$deleteOffer(offerId) {
    ...
    try {
        ...
        } else alert(result.error || "\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0443\u0434\u0430\u043B\u0435\u043D\u0438\u0438 \u0437\u0430\u044F\u0432\u043A\u0438");
    } catch (error) {
...
function $a8947760f7180fbb$var$createOfferResponseButton(offer) {
    return `
        <button class="btn btn-info btn-icon btn-sm" title="\u{41E}\u{442}\u{432}\u{435}\u{442}\u{438}\u{442}\u{44C}"
                onclick="openOfferResponseModal({
                    id: ${offer.id},
                    description: '${$a8947760f7180fbb$var$escapeHtml(offer.description || '')}',
                    response: '${$a8947760f7180fbb$var$escapeHtml(offer.response || '')}',
                    status: '${offer.status}'
                })">
